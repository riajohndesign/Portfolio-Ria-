    ...
    <div style={{ minHeight: "100vh", background: "#ffffff", color: "#111111" }}>
      ...
      <section className="px-6 md:px-12 lg:px-20 py-[100px]" style={{ background: "#ffffff" }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <img src={figmaOverviewArt} alt="Overview illustration" className="w-full max-w-[620px] h-auto justify-self-end" draggable={false} />
        </div>
      </section>
      ...
      <section className="relative px-6 md:px-12 lg:px-20 py-[100px]" style={{ background: "#f2f2f2" }}>
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10">
            <div className="rounded-[20px] border border-[#e3e3e3] bg-white p-4 shadow-[0px_0px_4px_2px_rgba(0,0,0,0.05)]">
          ...
          <div className="rounded-[20px] border border-[#e3e3e3] bg-white p-4 shadow-[0px_0px_4px_2px_rgba(0,0,0,0.05)] max-w-[620px] mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            ...
            <article key={item.title}>
              <div className="h-[175px] mb-6 flex items-center justify-center">
                <img src={item.image} alt={item.title} className="max-h-full w-auto" draggable={false} />
              </div>
              <h3 className="text-[41px] md:text-[26px] font-bold leading-[1.2] mb-4">{item.title}</h3>
              <p className="text-[18px] leading-[29.25px] mb-8">{item.body}</p>
              <p className="text-[16px] tracking-[2px] uppercase mb-2" style={{ color: "#048574" }}>INSIGHT SYNTHESIS</p>
      ...
      <section className="px-6 md:px-12 lg:px-20 py-[91px]" style={{ background: "#ffffff" }}>
        <div className="border-t border-[#e0ddd6] pt-[60px]">
